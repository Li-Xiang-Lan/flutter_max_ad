...
/*Initialize SDK*/
  ...
  Future<void> integrationChecking()async{
    await AnythinkSdk.channel.invokeMethod("integrationChecking");
  }

  Future<void> setDebuggerConfig(String deviceId)async{
    await AnythinkSdk.channel.invokeMethod("setDebuggerConfig",{"deviceId":deviceId});
  }
}
