...
//                    ATSDK.setExcludeMyOfferPkgList(bundleIdList);
            ...
            case "setPresetPlacementConfigPath":
                ...
                break;
            case "integrationChecking":
                ATSDK.integrationChecking(FlutterPluginUtil.getApplicationContext());
                break;
            case "setDebuggerConfig":
                String deviceId = (String) methodCall.argument("deviceId");
                ATSDK.setDebuggerConfig(FlutterPluginUtil.getApplicationContext(), deviceId, null);
                break;
        }
        return true;
    }
